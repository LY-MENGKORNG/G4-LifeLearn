<template>
    <WebLayout>
      <div class="flex justify-center max-w-4xl shadow-md mx-auto items-center bg-gray-100 mt-5">
  ...
  />
          ...
          <el-form class="flex-1 p-10 text-start">
            <h2 class="text-2xl font-bold mb-6">Logout</h2>
            ...
            <el-button native-type="submit" class="w-full mt-3 bg-teal-500 hover:bg-teal-500 active:bg-teal-600 text-white">Sign In</el-button>
          </el-form>
        </el-container>
      </div>
    </WebLayout>
