            ...
            <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-8 mt-8">
                ...
                <div class="flex flex-wrap -mx-3 mb-2">
                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        <label class="block mb-2 text-sm " for="payment">Payment</label>
                ...
                <div class="flex flex-wrap -mx-3 mb-4">
                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        <label class="block mb-2 text-sm " for="card-number">Card Number</label>
                        <el-input id="card-number" type="card-number" />
                    </div>
                    <div class="w-full md:w-1/2 px-3">
                        <label class="block mb-2 text-sm " for="security">Security Code</label>
                ...
                <div class="w-full">
                    <label class="block mb-2 text-sm " for="reference">Your Referent</label>
                    <upload-file />
                </div>
                <div class="flex items-center justify-between">
                    <router-link to="">
                        <el-button
                            class="bg-teal-500 text-white font-bold py-4 px-10 text-1.5xl hover:bg-teal-500 focus:bg-teal-500">Save</el-button>
                    </router-link>
                    <router-link to="/system">
                        <el-button
                            class="font-bold py-4 px-10 text-1.5xl hover:bg-gray-500 focus:bg-gray-500 hover:text-white focus:text-white">Cancel</el-button>
                    </router-link>
                </div>
            </form>
        </div>
