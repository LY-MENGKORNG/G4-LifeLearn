<template>
  <WebLayout>
    <Header>
      <div class="container">
        <div class="flex gap-10 p-10">
          ...
          <div>
            <div>
              <p class="text-3xl text-teal-400 font-bold text-align-center py-3">LifeLearn System</p>
              <h5
                class="py-2 text-4xl text-align-center font-bold tracking-tight text-gray-900 dark:text-white"
              >
                Empower Your
    ...
    <div class="card-find flex flex-wrap gap-10 justify-center">
      <div
        class="mt-5 me-4 block rounded-lg border border-teal-400 bg-white shadow-secondary-1 dark:bg-surface-dark dark:text-white text-surface overflow-hidden hover:shadow-md hover:transform hover:-translate-y-5 transition duration-300 ease-in-out"
        style="width: 18rem"
      >
        <div class="p-6 flex flex-wrap items-center justify-center">
          <svg
            ...
            stroke-width="1.5"
            stroke="#38b2ac"
            class="size-6 border border-teal-500"
          >
            <!-- Lightbulb Icon -->
            <path
        ...
        <hr class="mx-auto my-1 w-11/12 border-teal-500" />
        <p class="p-6 text-base text-center">
          <b>Course Code: 12345</b><br />Enrich your learning experience with our comprehensive
          curriculum.
        </p>
      </div>
      <div
      ...
      >
        <div class="p-6 flex flex-wrap items-center justify-center">
          <svg
            ...
            stroke-width="1.5"
            stroke="#38b2ac"
            class="size-6 border border-teal-400"
          >
        ...
        <hr class="mx-auto my-1 w-11/12 border-teal-400" />
        <p class="p-6 text-base text-center">
          <b>Resource ID: 12345</b><br />Explore additional resources and content to aid your
          studies.
        </p>
      </div>
      <div
      ...
      >
        ...
        <hr class="mx-auto my-1 w-11/12 border-teal-400" />
        <p class="p-6 text-base text-center">
          <b>Group ID: 12345</b><br />Join study groups and participate in collaborative projects.
        </p>
      </div>
    </div>
    ...
    <!-- // card -->
    <div class="title">
      <h3 class="mt-5 text-center text-black-400 font-bold text-2xl">Key elements in​ System</h3>
      <p class="text-center text-gray-400 p-3">
    ...
    <div class="card-details flex flex-wrap gap-4">
      <div
    ...
    <div class="info">
      <div class="title">
        <h3 class="mt-5 text-start text-black-400 font-bold text-2xl py-3">Information</h3>
        <button
          class="text-center text-white bg-gray-900 hover:bg-gray-500 p-3 rounded-lg shadow-md"
        >
        <button
          class="text-center text-white bg-gray-900 hover:bg-gray-500 p-3 rounded-lg shadow-md"
        >
...
/* Adjust individual card styles as needed */
.block {
  flex: 1 0 18rem; /* This sets the minimum width of each card */
  max-width: calc(25% - 1rem); /* This sets the maximum width to fit 4 cards in a row with a gap */
}
</style>
