	...
	<WebLayout>
		<header>
			...
			<div class="relative h-[350px] overflow-hidden">
				<img src="https://www.aigtechnologies.in/images/products/school-management.jpg"
		...
		<div class="card-find p-5 flex flex-wrap gap-10 justify-center">
			<div class="mt-5 me-4 block rounded-lg border border-[#42b883] bg-white shadow-secondary-1 dark:bg-surface-dark dark:text-white text-surface overflow-hidden hover:shadow-md hover:transform hover:-translate-y-5 transition duration-300 ease-in-out"
				style="width: 20rem">
				<div class="p-6 flex flex-wrap items-center justify-center">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" fill="none" stroke-width="1.5"
						stroke="#42b883" class="size-6 border border-[#42b883]">
						<!-- Lightbulb Icon -->
				...
				<p class="p-6 text-base text-center">
					<b class="text-[#42b883]">Course Code: 12345</b><br />Enrich your learning experience with our
					comprehensive
					curriculum.
				</p>
			</div>
			<div class="mt-5 me-4 block rounded-lg border border-[#42b883] bg-white shadow-secondary-1 dark:bg-surface-dark dark:text-white text-surface overflow-hidden hover:shadow-md hover:transform hover:-translate-y-5 transition duration-300 ease-in-out"
				...
				<hr class="mx-auto my-1 w-11/12 border-[#42b883]" />
				<p class="p-6 text-base text-center">
					<b class="text-[#42b883]">Resource ID: 12345</b><br />Explore additional resources and content to
					aid your
					studies.
				</p>
			</div>
			<div class="mt-5 me-4 block rounded-lg border border-[#42b883] bg-white shadow-secondary-1 dark:bg-surface-dark dark:text-white text-surface overflow-hidden hover:shadow-md hover:transform hover:-translate-y-5 transition duration-300 ease-in-out"
				...
				<hr class="mx-auto my-1 w-11/12 border-[#42b883]" />
				<p class="p-6 text-base text-center">
					<b class="text-[#42b883]">Group ID: 12345</b><br />Join study groups and participate in
		...
		<div class="flex flex-wrap gap-5 p-5 justify-content-between">
			<div
				...
				<div class="p-6">
					...
					<div class="flex flex-wrap gap-2">
						...
						<button class="bg-gray-300 rounded-lg px-3 py-1 text-xs leading-tight">#Goal
							Achievement</button>
					</div>
				</div>
			</div>
			...
			<div
				...
				<div class="relative overflow-hidden bg-cover bg-no-repeat">
					<img class="rounded-t-lg"
						src="https://i.pinimg.com/564x/cc/d0/d4/ccd0d47149edc02c5783543566425b77.jpg" alt="" />
				</div>
				<div class="p-6">
					<h5 class="mb-2 text-xl text-start font-medium leading-tight text-[#42b883]">
						<b>Notifacation</b>
		...
		<div class="info p-5">
			<div class="title">
				...
				<div class="flex justify-center" v-if="connection">
					<router-link v-if="path == 'payment'" to="/systems/payment">
						<el-button
