      ...
      <div class="w-100% grid gap-3 px-20 py-8">
        ...
        <div class="homework flex flex-row space-x-5 rounded-xl">
          <div class="view bg-white space-y-5 h-fit w-81 p-4 rounded-xl">
            ...
            </router-link><router-link to="/system/peopl">
          ...
          <div class="scrollable-content border-2 rounded-xl w-full px-3 space-y-3">
            <StudentList class="bg-white py-3 px-6 rounded-xl mb-3 shadow-xl" />
            <router-link to="/system/submitform" class="space-y-3">
              <HomeworkDetail v-for="index in 8" :key="index" />
            </router-link>
          </div>
        </div>
      </div>
