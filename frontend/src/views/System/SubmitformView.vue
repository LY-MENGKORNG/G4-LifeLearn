      ...
      <div class="flex items-cente w-full px-3">
        <div class="w-full">
          ...
          <a :href="'http://localhost:8000/documents/' + quiz.fields" target="_blank">
            <img
              class="w-20 h-26 pt-3"
              src="https://static.javatpoint.com/definition/images/pdf-definition.jpg"
            />
          </a>
          <div class="w-40 pt-3 space-y-3 pb-3">
            <a :href="quiz.links" class="w-120 text-blue-600 underline"
              >links_here_clicked/copy</a
            >
        ...
        <div class="flex flex-col shadow bg-white p-4 w-70 space-y-3 rounded">
          ...
          <form @submit.prevent="SubmitQuiz">
            ...
            <div class="flex">
              <input
                type="number"
                class="text-white w-12"
                v-model="submitted.classroom_id"
              />
              <input
                type="number"
                class="text-white w-12"
                v-model="submitted.assignment_id"
              />
            </div>
            <button
              type="submit"
              class="border-1 border-gray-500 p-2 rounded items-center w-full text-blue-700"
            >
              Submit
            </button>
          </form>
