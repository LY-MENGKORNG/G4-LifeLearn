    ...
    <main class="w-full flex flex-wrap gap-4 overflow-x-hidden overflow-y-auto bg-gray-100 p-4">
        <div class="flex flex-col" style=" min-width: 65%">
            <div class="mx-auto flex-1  flex  w-full gap-3">
                ...
                <x-overview-card link="admin.systems.index" active="pink-300" title="Total Systems" :number="$systems->count()">
                    <svg viewBox="0 0 24 24" style="width: 30px" fill="none" xmlns="http://www.w3.org/2000/svg">
